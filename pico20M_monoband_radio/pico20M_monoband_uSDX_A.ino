/*
  ...
  OLED 128x64 VFO+RX_Bandscope Waterfall JR3XNW 2024/4/26
*/
...
unsigned long long pll_freq = 75000000000ULL; //75000000000ULL//65000000000ULL
...
void loop() {
  ...
  for (int i = 0; i < SAMPLES; i++) {
    vReal[i] = (analogRead(Q_IN) - 2048) * 3.3 / 4096.0;
...
void showGraphics() {  // Modifying Graphs
  ...
  freqt = String (FREQ);
  u8g2.setCursor(2,1);
  u8g2.print(freqt.substring(0,2) + "." + freqt.substring(2,5) + "." + freqt.substring(5));
