/*
  ...
  OLED 128x64 VFO+RX_Bandscope Waterfall JR3XNW 2023/6/19
*/
...
unsigned long long pll_freq = 65000000000ULL; //75000000000ULL
...
void setup() {
  ...
  Wire.begin();
  si5351.init(SI5351_CRYSTAL_LOAD_8PF, 24999518, 0);  //Reference transmitting frequency of Si5351 //27003411//3593
